...
public class FetchMoreUserStocksListener extends FetchMoreItemsCommand {
    
    private UserUrlName mUserUrlName;
    
    public FetchMoreUserStocksListener(ListView listView, LayoutInflater inflater, ArrayAdapter<Item> adapter, UserUrlName userUrlName) {
